...
import log_handlers, katcp_wrapper, time, struct, sys, logging, Gnuplot, telnetlib, numpy as np
from math import *
import adc5g
...
# measurement
    ...
    modo_memoria=input('modo memoria? (1 (cal real),2 (cal ideal) o 3 (sin cal))=')
    g2.clear()    
...
################################################################ # modo_memoria=1 (para completar con datos optimizados o teoricos) 
    ...
    if modo_memoria == 1:
        srr_datos=open('srr_datos_modo1.dat','w')
        datos_teo_corregido=open('datos_teo_corregido_modo1.dat','w')
    ...
    # para que se puedan leer en Matlab y generar los graficos correspondientes.
        ...
        srr_datos=open('srr_datos_modo2.dat','w')
        datos_teo_corregido=open('datos_teo_corregido_modo2.dat','w')
        for i in range(512):
        ...
        srr_datos=open('srr_datos_modo3.dat','w')
        datos_teo_corregido=open('datos_teo_corregido_modo3.dat','w')
        for i in range(512):
    ...
    if modo == 1:
        ...
        for i in range(points):
            ...
            print ('Sweeping tone '+ str(i+1) + ' at ' + str(start+((stop-start)*i/points)) + 'GHz')
